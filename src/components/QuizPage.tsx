...
export default function QuizPage({ onBack }: QuizPageProps) {
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-8 text-center">
          ...
          >
            ...
            <div className="mb-8">
              <motion.button
                onClick={onBack}
                className="bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white px-8 py-4 rounded-full font-bold"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 relative overflow-hidden">
      ...
      {/* Progress bar */}
      <div className="absolute top-8 right-8 z-20 bg-white/90 px-6 py-3 rounded-full font-bold text-blue-800">
            ...
            >
                ...
                {currentQuestion.options.map((option, index) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`w-full text-left p-6 rounded-xl border-2 transition-all duration-300 ${buttonStyle} ${showAnswerFeedback ? 'cursor-default' : 'cursor-pointer'
                        }`}
                      whileHover={!showAnswerFeedback ? { scale: 1.02 } : {}}
                      whileTap={!showAnswerFeedback ? { scale: 0.98 } : {}}
                    >
                      <div className="flex items-start space-x-4">
                        <span className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${showAnswerFeedback && isCorrectAnswer
              ...
              <div className="flex justify-between items-center">
                <motion.button
                  ...
                  className={`px-6 py-3 rounded-full font-bold transition-all duration-300 ${currentQuestionIndex === 0
                ...
                <motion.button
                  ...
                  className={`px-6 py-3 rounded-full font-bold transition-all duration-300 ${selectedAnswers[currentQuestionIndex] === -1
                    ? 'bg-gray-600/50 text-gray-400 cursor-not-allowed'
